...
`desc select * from student where tel='111111'`这个语句执行的时候，都是NULL，所以性能肯定是最高的。

![](https://github.com/Christian-health/christian-health.github.io/blob/master/img/typenulll.jpg?raw=true)
